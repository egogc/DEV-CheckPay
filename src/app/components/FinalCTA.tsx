...
import { Mail, ArrowRight, Sparkles, Instagram, Facebook, Twitter, Linkedin, Youtube } from 'lucide-react';
import { useState } from 'react';
import { CheckPayBrand } from './CheckPayBrand';

const socialLinks = [
  { href: 'https://www.instagram.com/CheckPayApp', label: 'Instagram', icon: <Instagram className="w-4 h-4" /> },
  { href: 'https://www.facebook.com/CheckPayApp', label: 'Facebook', icon: <Facebook className="w-4 h-4" /> },
  {
    href: 'https://www.tiktok.com/@checkpayapp', label: 'TikTok',
    icon: (
  ...
  { href: 'https://x.com/CheckPayApp', label: 'X', icon: <Twitter className="w-4 h-4" /> },
  { href: 'https://www.linkedin.com/company/checkpayapp', label: 'LinkedIn', icon: <Linkedin className="w-4 h-4" /> },
  { href: 'https://www.youtube.com/@checkpayapp', label: 'YouTube', icon: <Youtube className="w-4 h-4" /> },
];
        ...
        <div className="flex justify-center gap-3 mb-4">
          {socialLinks.map(({ href, label, icon }) => (
            <a
              ...
              aria-label={label}
              className="w-8 h-8 flex items-center justify-center rounded-full bg-[#13131a]/80 border border-gray-800 text-gray-400 hover:text-white hover:border-[#7863fe] hover:bg-[#7863fe]/20 transition-all duration-200"
            >
              {icon}
            </a>
          ))}
